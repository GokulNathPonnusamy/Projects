            ...
            <div class="card transparent-card">
              ...
              <div class="card-body">
                <form class="m-4 mr-5" id="loginForm" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                  ...
                  <div class="form-group">
                    <label for="role" class="text-primary"><strong>Login As:</strong></label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        if ($role === 'user') {
            header("Location: ./student.php"); // Redirect user to home page
            exit(); // Stop script execution after redirection
        } else if ($role === 'admin') {
            header("Location: ./admin.php"); // Redirect admin to admin home page
            exit(); // Stop script execution after redirection
        }
